...
static unsigned int compute_response_length_from_request(modbus_t *ctx, uint8_t *req){
    ...
    switch (req[offset]) {
    ///[RTU_Read_Bits][TCP_Read_Bits][TCP_PI_Read_Bits]
    case MODBUS_FC_READ_COILS:
    ///[RTU_Read_Input_Bits][TCP_Read_Input_Bits][TCP_PI_Read_Input_Bits]
    case MODBUS_FC_READ_DISCRETE_INPUTS: {
        ...
        break;
    ///[RTU_Write_And_Read_Registers][TCP_Write_And_Read_Registers][TCP_PI_Write_And_Read_Registers]
    case MODBUS_FC_WRITE_AND_READ_REGISTERS:
    ///[RTU_Read_Registers][TCP_Read_Registers][TCP_PI_Read_Registers]
    case MODBUS_FC_READ_HOLDING_REGISTERS:
    ///[RTU_Read_Input_Registers][TCP_Read_Input_Registers][TCP_PI_Read_Input_Registers]
    ...
    case MODBUS_FC_READ_EXCEPTION_STATUS:
        length = 3;
        break;
    ///[RTU_Report_Slave_ID][TCP_Report_Slave_ID][TCP_PI_Report_Slave_ID]
    case MODBUS_FC_REPORT_SLAVE_ID:
        /* The response is device specific (the header provides the
           length) */
        return MSG_LENGTH_UNDEFINED;
    ///[RTU_Mask_Write_Register][TCP_Mask_Write_Register][TCP_PI_Mask_Write_Register]
...
///[RTU_Send_Raw_Request][TCP_Send_Raw_Request][TCP_PI_Send_Raw_Request]
                                                  ...
                                                  msg_type_t msg_type)
{
    ...
    if (msg_type == MSG_INDICATION) {
        ///[RTU_Write_Register][TCP_Write_Register][TCP_PI_Write_Register]
    	if (function <= MODBUS_FC_WRITE_SINGLE_REGISTER) {
            length = 4;
        }
    	///[RTU_Write_Bits][RTU_Write_Registers][TCP_Write_Bits][TCP_Write_Registers][TCP_PI_Write_Bits][TCP_PI_Write_Registers]
        ...
        /* MSG_CONFIRMATION */
        switch (function) {
        ///[RTU_Write_Bit][TCP_Write_Bit][TCP_PI_Write_Bit]
        case MODBUS_FC_WRITE_SINGLE_COIL:
        ///[RTU_Write_Register][TCP_Write_Register][TCP_PI_Write_Register]
        case MODBUS_FC_WRITE_SINGLE_REGISTER:
        ///[RTU_Write_Bits][TCP_Write_Bits][TCP_PI_Write_Bits]
        case MODBUS_FC_WRITE_MULTIPLE_COILS:
        ///[RTU_Write_Registers][TCP_Write_Registers][TCP_PI_Write_Registers]
                                          ...
                                          msg_type_t msg_type)
{
    ...
    if (msg_type == MSG_INDICATION) {
        ...
        /* MSG_CONFIRMATION */
        ///[RTU_Read_Input_Registers][TCP_Read_Input_Registers][TCP_PI_Read_Input_Registers][RTU_Report_Slave_ID][TCP_Report_Slave_ID][TCP_PI_Repot_Slave_ID][RTU_Write_And_Read_Registers][TCP_Write_And_Read_Registers][TCP_PI_Write_And_Read_Registers]
...
/* Reads IO status */
///[RTU_Read_Bits][RTU_Read_Input_Bits][TCP_Read_Bits][TCP_Read_Input_Bits][TCP_PI_Read_Bits][TCP_PI_Read_Input_Bits]
...
///[RTU_Read_Registers][TCP_Read_Registers][TCP_PI_Read_Registers][RTU_Read_Input_Registers][TCP_Read_Input_Registers][TCP_PI_Read_Input_Registers]
...
///[RTU_Write_Bit][TCP_Write_Bit][TCP_PI_Write_Bit][RTU_Write_Register][TCP_Write_Register][TCP_PI_Write_Register]
